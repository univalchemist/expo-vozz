...
const CardHome = (props) => (
    ...
    <TouchableHighlight underlayColor="#ffffff00" style={[styles.shadow, styles.container]} onPress={() => props.me ? props.navigation.navigate('Route', { me: props.me, route_id: props.item._id }) : props.navigation.navigate('ViewRoute', { route_id: props.item._id })}>
