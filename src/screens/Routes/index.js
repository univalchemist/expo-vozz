...
import { FlatList, StatusBar, TouchableOpacity, Dimensions, Alert } from 'react-native';
import { Container, Content, List, ListItem, Left, Body, Right, CheckBox, Icon, View } from 'native-base';
...
class Routes extends Component {
    ...
    onTapNext = () => {
        ...
        this.props.navigation.navigate('AddDetails', { records: temp });
    }
    ...
    onTapPlayRow = (play, key, index) => {
        ...
        if (temp[`${key}`][index]['item']['audio'] != null) {
...
export default withApollo(connect(mapStateToProps)(Routes));