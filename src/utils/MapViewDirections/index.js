...
class MapViewDirections extends Component {
	...
	fetchAndRenderRoute = () => {
		...
		this.fetchRoute(origin, destination, apikey, selected_type)
			.then(result => {
	...
	fetchRoute = (origin, destination, apikey, selected_type) => {
		const mode = selected_type ? selected_type : 'driving';
